...
- Phase: Phase1〜13は完了、Phase14（MISRA対応）は着手中（cppcheck `--addon=misra`で検出した12ルールのうち、判断の軽いグループ1（5.9・8.9・10.4・10.8・15.6・15.7、計6ルール）を解消済み。残るグループ2（17.7）・グループ3（21.6/21.10・12.1・15.5）は未着手。詳細はstudy_plan.md参照）
